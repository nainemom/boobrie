...
export const textarea = tv({
	base: [
		'outline-none border resize-y min-h-32 select-text',
	...
	variants: {
		size: {
			6: 'h-6 p-2 rounded-sm text-xs',
			8: 'h-8 p-2.5 rounded-sm text-xs',
			10: 'h-10 p-3 rounded-sm text-sm',
			12: 'h-12 p-4 rounded-sm text-sm',
		},
	},
	defaultVariants: {
		size: 10,
