...
/**
 * `/auth/:step?` — the whole gate behind a single route, so `peer` rides along
 * on every hop between steps instead of each step needing its own entry in the
 * router (and its own chance to drop the query).
 *
